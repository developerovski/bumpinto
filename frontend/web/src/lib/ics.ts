/* Takvim (W8 `.rc` "Takvime ekle"): sunucuda kayıtlı bir buluşma saati YOK — kullanıcı W9
   `MeetTimeDialog`da bir saat seçer, bu dosya seçilen saatten `.ics` metni ve Google Calendar
   linki üretir. `icsStamp` HER ZAMAN `getUTC*` okur (Date her zaman mutlak an taşır, hangi yerel
